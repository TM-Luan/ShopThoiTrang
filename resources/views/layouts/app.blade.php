...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 text-center">
            <p style="margin-top: 10px;"> &copy;<script>document.write(new Date().getFullYear());</script> - Bản quyền thuộc về Hafos Fashion | Website được tạo bởi <i class="fa fa-heart" aria-hidden="true"></i> của <b>Minh Luan</b></p>
        </div>
    </div>
</div>
